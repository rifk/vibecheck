...
- Remote path contracts:
  ...
  - `/Users/rif/code/testProject/composeApp/src/commonMain/kotlin/com/vibecheck/data/TemplateRemotePuzzleClient.kt`
...
1. Implement a concrete `RemotePuzzleClient` (HTTP layer, auth, retries), or use `TemplateRemotePuzzleClient`.
